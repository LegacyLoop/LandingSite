    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '64px 32px 120px' }}>
        ...
        <ol style={{ ...list, listStyleType: 'decimal' }}>
          ...
          <li style={li}>Include the email address associated with your LegacyLoop account</li>
        ...
        <p style={body}>If you have an active LegacyLoop account, you can initiate immediate deletion directly from the app:</p>
        <ol style={{ ...list, listStyleType: 'decimal' }}>
        ...
        <p style={body}>If you connected your Facebook or Instagram account to LegacyLoop, we will remove all data obtained through those connections within 30 days of your deletion request. Our use of Meta-provided data complies with Meta&apos;s Platform Terms and Developer Policies.</p>
        <p style={body}>You can also revoke LegacyLoop&apos;s access to your Meta accounts directly:</p>
        ...
        <ol style={{ ...list, listStyleType: 'decimal' }}>
          ...
          <li style={li}>Find &ldquo;LegacyLoop&rdquo; in your active apps list</li>
        ...
        <ol style={{ ...list, listStyleType: 'decimal' }}>
          ...
          <li style={li}>Find &ldquo;LegacyLoop&rdquo; under Active</li>
        ...
        <p style={body}>If you connected eBay, Mercari, Poshmark, or other marketplace accounts to LegacyLoop, we will remove all stored credentials and listing data associated with your account within 30 days of your deletion request. We recommend you also revoke LegacyLoop&apos;s access via each marketplace&apos;s app authorization settings.</p>
        ...
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(0,188,212,0.15)', borderRadius: 12, padding: 24, marginTop: 16 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '140px 1fr', gap: '12px 24px', fontFamily: 'var(--font-body)', fontSize: 15 }}>
            ...
            <span style={{ color: '#CBD5E1' }}>LegacyLoop Tech LLC, Maine, USA</span>
          </div>
        </div>
      ...
      <footer style={{ borderTop: '1px solid rgba(0,188,212,0.08)', padding: '32px', textAlign: 'center' }}>
        <p style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: '#6B7280' }}>&copy; 2026 LegacyLoop Tech LLC. All rights reserved. | <a href="/landing" style={{ color: '#6B7280', textDecoration: 'none' }}>Home</a> | <a href="/privacy" style={{ color: '#6B7280', textDecoration: 'none' }}>Privacy Policy</a> | <a href="/terms" style={{ color: '#6B7280', textDecoration: 'none' }}>Terms of Service</a></p>
      </footer>
    </div>
  )
}
